...
result <- foreach(i = 1:n_rep_, .packages = c("dbarts","SoftBart","MOTRbart","dplyr")) %dopar%{
  ...
  devtools::load_all()
  source("/users/research/mmarques/spline_bart_lab/rspBART10/R/sim_functions.R")
  source("/users/research/mmarques/spline_bart_lab/rspBART10/R/main_function.R")
  source("/users/research/mmarques/spline_bart_lab/rspBART10/R/cv_functions.R")
  # if(ntree_<50) {
...
# Saving all
# if(all_){
# saveRDS(object = result,file = paste0("/localusers/research/mmarques/spline_bart_lab/preliminar_results/rspBART10/oned_n_",n_,
...
if(type_ == "friedman_nointer_nonoise"){
    if(all_){
      if(!stump_){
          saveRDS(object = result,file = paste0("/users/research/mmarques/spline_bart_lab/preliminar_results/rspBART10/friedman_noint_nonoise/oned_n_",n_,
...
if(type_ == "friedman_inter_noise"){
      saveRDS(object = result,file = paste0("/users/research/mmarques/spline_bart_lab/preliminar_results/rspBART10/friedman/new_interaction_",inter_,"_oned_n_",n_,
                                            "_sd_",sd_,"_nIknots_",nIknots_,"_ntree_",ntree_,"_bs_",use_bs_,
                                            "_motr_bart_",motr_bart_,"_allvar_",all_,"_stump_",stump_,
                                            "_sinit_",scale_init_,"_alpha_",alpha_,"_uptaubeta_",update_tau_beta_,"_dif_",dif_order_,".Rds"))
}
...
if(type_ == "friedman_nointer_noise"){
  saveRDS(object = result,file = paste0("/users/research/mmarques/spline_bart_lab/preliminar_results/rspBART10/friedman_noint_noise/oned_n_",n_,
                                        "_sd_",sd_,"_nIknots_",nIknots_,"_ntree_",ntree_,"_bs_",use_bs_,
                                        "_motr_bart_",motr_bart_,"_allvar_",all_,"_stump_",stump_,
                                        "_sinit_",scale_init_,"_alpha_",alpha_,"_uptaubeta_",update_tau_beta_,"_dif_",dif_order_,".Rds"))
}
